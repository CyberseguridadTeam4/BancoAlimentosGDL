...
const PasswordMeter: React.FC<PasswordMeterProps> = ({
  ...
  function medium() {
    let medium = false;
    if (acceptedCriteriaCount() >= 2 && acceptedCriteriaCount() <= 3)
      medium = true;
    return medium;
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerInline}>
        <BAText style={styles.description}>Nivel de confianza:</BAText>
        {low() ? (
          <BAText style={styles.bajo}> BAJO </BAText>
        ) : (
          <BAText style={styles.description}> BAJO </BAText>
        )}
        <BAText style={styles.description}>|</BAText>
        {medium() ? (
          <BAText style={styles.medio}> MEDIO </BAText>
        ) : (
          <BAText style={styles.description}> MEDIO </BAText>
        )}
        <BAText style={styles.description}>|</BAText>
        {high() ? (
          <BAText style={styles.alto}> ALTO </BAText>
        ) : (
          <BAText style={styles.description}> ALTO </BAText>
        )}
      </View>
      <View>
        <BAText style={styles.incluye}>Incluye:</BAText>
