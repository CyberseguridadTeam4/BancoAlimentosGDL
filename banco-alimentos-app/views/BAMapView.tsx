...
export default function BAMapView() {
  ...
  useEffect(() => {
    fetch(
      "https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJEyCF-AayKIQRhWWzownuQ8s&fields=name,formatted_phone_number,geometry,vicinity&key=AIzaSyBZ-L6y4RM_Adga1qdKEj8ZTMCBkMHE_3o"
    )
      ...
      <View style={styles.textContainer}>
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity onPress={handlePress}>
            {phoneNumber && (
              <BAText style={styles.phoneLabel}>{phoneNumber}</BAText>
            )}
          </TouchableOpacity>
        </View>
      </View>
